...
conf_path = '/content/D4LCN/pretrain/conf.pkl'
weights_path = '/content/drive/MyDrive/model_40000_pkl'

# load config
conf = edict(pickle_read(conf_path))

data_path = "/content/D4LCN/data_test" #os.path.join(os.getcwd(), 'data')
results_path = "/content/D4LCN/data_test/output" #os.path.join('output', 'pretrain', 'data')
